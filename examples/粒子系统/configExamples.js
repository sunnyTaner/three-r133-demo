...
/*
	...
	emitterDeathAge    : 60
*/
import {Type, ParticleTween} from './js/ParticleEngine.js'
...
const Examples =
{
	...
	fireball :
	{
		...
		sizeTween    : new ParticleTween( [0, 0.1], [1, 150] ),
		opacityTween : new ParticleTween( [0.7, 1], [1, 0] ),
	...
	snow :
	{
		...
		sizeTween    : new ParticleTween( [0, 0.25], [1, 10] ),
	...
	fireflies :
	{
		...
		sizeBase   : 30.0,
		sizeSpread : 2.0,
		opacityTween : new ParticleTween([0.0, 1.0, 1.1, 2.0, 2.1, 3.0, 3.1, 4.0, 4.1, 5.0, 5.1, 6.0, 6.1],
	...
	firework :
	{
		...
		sizeTween    : new ParticleTween( [0.5, 0.7, 1.3], [5, 40, 1] ),
		opacityTween : new ParticleTween( [0.2, 0.7, 2.5], [0.75, 1, 0] ),
		colorTween   : new ParticleTween( [0.4, 0.8, 1.0], [ new THREE.Vector3(0,1,1), new THREE.Vector3(0,1,0.6), new THREE.Vector3(0.8, 1, 0.6) ] ),
		blendStyle   : THREE.AdditiveBlending,
    ...
    candle :
	{
		...
		sizeTween    : new ParticleTween( [0, 0.3, 1.2], [20, 150, 1] ),
		opacityTween : new ParticleTween( [0.9, 1.5], [1, 0] ),
