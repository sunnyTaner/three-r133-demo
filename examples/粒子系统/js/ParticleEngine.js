...
import {Geometry,Face3} from '../../../examples/jsm/deprecated/Geometry.js'
...
ParticleEngine.prototype.initialize = function () {
	...
	this.bufferGeometry=this.particleGeometry.toBufferGeometry()
...
ParticleEngine.prototype.update = function (dt) {
	...
	// bufferGeometry需要更新
	//this.bufferGeometry.fromGeometry(this.particleGeometry);
	const positions = new Float32Array( this.particleGeometry.vertices.length * 3 )
	this.bufferGeometry.setAttribute('position', new THREE.BufferAttribute( positions, 3 ).copyVector3sArray( this.particleGeometry.vertices ));
