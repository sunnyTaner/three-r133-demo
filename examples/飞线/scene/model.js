...
var curve = new THREE.CatmullRomCurve3(points2);// 从获取的一段点创建一小段曲线
var newPoints2 = curve.getSpacedPoints(100); //从这小段曲线再分100段获取101点，获取更多的点数
...
for (var i = 0; i < newPoints2.length; i++) {
  ...
  var color = color1.lerp(color2, i / newPoints2.length)//青色渐变到黄色
  colorArr.push(color.r, color.g, color.b);
}
// 设置几何体顶点颜色数据  Float32Array：平台字节顺序为32位的浮点数型数组 点数据量很大，为了提高传输效率
